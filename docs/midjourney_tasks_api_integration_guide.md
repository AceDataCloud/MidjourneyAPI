...
This document will provide detailed instructions on integrating the Midjourney Tasks API, helping you easily integrate and fully utilize the powerful features of this API. With the Midjourney Tasks API, you can easily query the execution status of tasks from the Midjourney Imagine API or Midjourney Describe API.
...
We will take a task ID returned by the Midjourney Imagine API service as an example to demonstrate how to use this API. Suppose we have a task ID: 7489df4c-ef03-4de0-b598-e9a590793434, and we will demonstrate how to pass in a task ID.
